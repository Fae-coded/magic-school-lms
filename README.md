...
features here and technical explanations of how your application works under the hood
...
- [React]() was used to write the user interface and frontend.
- [Python Django]() was used to write the backend logic and REST APIs.
...
- Our weekly D&D game set in a magic school with my friends and partner.
